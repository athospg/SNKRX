...
function init()
                ...
                "x[fg], [blue]AREA: [blue]" ..
                  math.round(player.area_dmg_m * player.area_size_m, 2) ..
                    "x[fg], [yellow]DEF: [yellow]" ..
                      math.round(player.def, 2) .. "[fg], [green]MVSPD: [green]" .. math.round(player.v, 2) .. "[fg]"
  end
  ...
  character_descriptions = {
    ["vagrant"] = function(lvl)
      return "[fg]shoots a projectile that deals [yellow]" .. get_character_stat("vagrant", lvl, "dmg") .. "[fg] damage"
    end,
    ...
    ["wizard"] = function(lvl)
      return "[fg]shoots a projectile that deals [yellow]" ..
        get_character_stat("wizard", lvl, "dmg") .. " AoE[fg] damage"
    end,
    ["magician"] = function(lvl)
      return "[fg]creates a small area that deals [yellow]" ..
        get_character_stat("magician", lvl, "dmg") .. " AoE[fg] damage"
    end,
    ["archer"] = function(lvl)
      return "[fg]shoots an arrow that deals [yellow]" ..
        get_character_stat("archer", lvl, "dmg") .. "[fg] damage and pierces"
    end,
    ["scout"] = function(lvl)
      return "[fg]throws a knife that deals [yellow]" ..
        get_character_stat("scout", lvl, "dmg") .. "[fg] damage and chains [yellow]3[fg] times"
    end,
    ["cleric"] = function(lvl)
    ...
    ["outlaw"] = function(lvl)
      return "[fg]throws a fan of [yellow]5[fg] knives, each dealing [yellow]" ..
        get_character_stat("outlaw", lvl, "dmg") .. "[fg] damage"
    end,
    ["blade"] = function(lvl)
      return "[fg]throws multiple blades that deal [yellow]" ..
        get_character_stat("blade", lvl, "dmg") .. " AoE[fg] damage"
    end,
    ["elementor"] = function(lvl)
      return "[fg]deals [yellow]" ..
        get_character_stat("elementor", lvl, "dmg") .. " AoE[fg] damage in a large area centered on a random target"
    end,
    ["saboteur"] = function(lvl)
      return "[fg]calls [yellow]2[fg] saboteurs to seek targets and deal [yellow]" ..
        get_character_stat("saboteur", lvl, "dmg") .. " AoE[fg] damage"
    end,
    ["bomber"] = function(lvl)
      return "[fg]plants a bomb, when it explodes it deals [yellow]" ..
        2 * get_character_stat("bomber", lvl, "dmg") .. " AoE[fg] damage"
    end,
    ...
    ["cannoneer"] = function(lvl)
      return "[fg]shoots a projectile that deals [yellow]" ..
        2 * get_character_stat("cannoneer", lvl, "dmg") .. " AoE[fg] damage"
    end,
    ["dual_gunner"] = function(lvl)
      return "[fg]shoots two parallel projectiles, each dealing [yellow]" ..
        get_character_stat("dual_gunner", lvl, "dmg") .. "[fg] damage"
    end,
    ["hunter"] = function(lvl)
      return "[fg]shoots an arrow that deals [yellow]" ..
        get_character_stat("hunter", lvl, "dmg") .. "[fg] damage and has a [yellow]20%[fg] chance to summon a pet"
    end,
    ["sentry"] = function(lvl)
      return "[fg]spawns a rotating turret that shoots [yellow]4[fg] projectiles, each dealing [yellow]" ..
        get_character_stat("sentry", lvl, "dmg") .. "[fg] damage"
    end,
    ...
    ["spellblade"] = function(lvl)
      return "[fg]throws knives that deal [yellow]" ..
        get_character_stat("spellblade", lvl, "dmg") .. "[fg] damage, pierce and spiral outwards"
    end,
    ...
    ["engineer"] = function(lvl)
      return "[fg]drops turrets that shoot bursts of projectiles, each dealing [yellow]" ..
        get_character_stat("engineer", lvl, "dmg") .. "[fg] damage"
    end,
    ["plague_doctor"] = function(lvl)
      return "[fg]creates an area that deals [yellow]" ..
        get_character_stat("plague_doctor", lvl, "dmg") .. "[fg] damage per second"
    end,
    ["barbarian"] = function(lvl)
      return "[fg]deals [yellow]" ..
        get_character_stat("barbarian", lvl, "dmg") .. "[fg] AoE damage and stuns enemies hit for [yellow]4[fg] seconds"
    end,
    ["juggernaut"] = function(lvl)
      return "[fg]deals [yellow]" ..
        get_character_stat("juggernaut", lvl, "dmg") .. "[fg] AoE damage and pushes enemies away with a strong force"
    end,
    ["lich"] = function(lvl)
      return "[fg]launches a slow projectile that jumps [yellow]7[fg] times, dealing [yellow]" ..
        2 * get_character_stat("lich", lvl, "dmg") .. "[fg] damage per hit"
    end,
    ["cryomancer"] = function(lvl)
      return "[fg]nearby enemies take [yellow]" ..
        get_character_stat("cryomancer", lvl, "dmg") .. "[fg] damage per second"
    end,
    ["pyromancer"] = function(lvl)
      return "[fg]nearby enemies take [yellow]" ..
        get_character_stat("pyromancer", lvl, "dmg") .. "[fg] damage per second"
    end,
    ["corruptor"] = function(lvl)
      return "[fg]shoots an arrow that deals [yellow]" ..
        get_character_stat("corruptor", lvl, "dmg") .. "[fg] damage, spawn [yellow]3[fg] critters if it kills"
    end,
    ["beastmaster"] = function(lvl)
      return "[fg]throws a knife that deals [yellow]" ..
        get_character_stat("beastmaster", lvl, "dmg") .. "[fg] damage, spawn [yellow]2[fg] critters if it crits"
    end,
    ["launcher"] = function(lvl)
      return "[fg]all nearby enemies are pushed after [yellow]4[fg] seconds, taking [yellow]" ..
        2 * get_character_stat("launcher", lvl, "dmg") .. "[fg] damage on wall hit"
    end,
    ["jester"] = function(lvl)
    ...
    ["assassin"] = function(lvl)
      return "[fg]throws a piercing knife that deals [yellow]" ..
        get_character_stat("assassin", lvl, "dmg") ..
          "[fg] damage + [yellow]" .. get_character_stat("assassin", lvl, "dmg") / 2 .. "[fg] damage per second"
    end,
    ["host"] = function(lvl)
    ...
    ["barrager"] = function(lvl)
      return "[fg]shoots a barrage of [yellow]3[fg] arrows, each dealing [yellow]" ..
        get_character_stat("barrager", lvl, "dmg") .. "[fg] damage and pushing enemies"
    end,
    ["highlander"] = function(lvl)
      return "[fg]deals [yellow]" .. 5 * get_character_stat("highlander", lvl, "dmg") .. "[fg] AoE damage"
    end,
    ["fairy"] = function(lvl)
    ...
    ["arcanist"] = function(lvl)
      return "[fg]launches a slow moving orb that launches projectiles, each dealing [yellow]" ..
        get_character_stat("arcanist", lvl, "dmg") .. "[fg] damage"
    end,
    ["illusionist"] = function(lvl)
      return "[fg]launches a projectile that deals [yellow]" ..
        get_character_stat("illusionist", lvl, "dmg") .. "[fg] damage and creates copies that do the same"
    end,
    ["artificer"] = function(lvl)
      return "[fg]spawns an automaton that shoots a projectile that deals [yellow]" ..
        get_character_stat("artificer", lvl, "dmg") .. "[fg] damage"
    end,
    ["witch"] = function(lvl)
      return "[fg]creates an area that ricochets and deals [yellow]" ..
        get_character_stat("witch", lvl, "dmg") .. "[fg] damage per second"
    end,
    ...
    ["vulcanist"] = function(lvl)
      return "[fg]creates a volcano that explodes the nearby area [yellow]4[fg] times, dealing [yellow]" ..
        get_character_stat("vulcanist", lvl, "dmg") .. " AoE [fg]damage"
    end,
    ["warden"] = function(lvl)
    ...
    ["psychic"] = function(lvl)
      return "[fg]creates a small area that deals [yellow]" ..
        get_character_stat("psychic", lvl, "dmg") .. " AoE[fg] damage"
    end,
    ["miner"] = function(lvl)
      return "[fg]picking up gold releases [yellow]4[fg] homing projectiles that each deal [yellow]" ..
        get_character_stat("miner", lvl, "dmg") .. " [fg]damage"
    end,
    ...
    ["usurer"] = function(lvl)
      return "[fg]curses [yellow]3[fg] nearby enemies indefinitely with debt, dealing [yellow]" ..
        get_character_stat("usurer", lvl, "dmg") .. "[fg] damage per second"
    end,
    ...
    ["thief"] = function(lvl)
      return "[fg]throws a knife that deals [yellow]" ..
        2 * get_character_stat("thief", lvl, "dmg") .. "[fg] damage and chains [yellow]5[fg] times"
    end
  }
  ...
  character_effect_descriptions = {
    ...
    ["blade"] = function()
      return "[fg]deal additional [yellow]" ..
        math.round(get_character_stat("blade", 3, "dmg") / 3, 2) .. "[fg] damage per enemy hit"
    end,
    ["elementor"] = function()
    ...
    ["sage"] = function()
      return "[fg]when the projectile expires deal [yellow]" ..
        3 * get_character_stat("sage", 3, "dmg") .. "[fg] damage to all enemies under its influence"
    end,
    ["squire"] = function()
    ...
    ["cannoneer"] = function()
      return "[fg]showers the hit area in [yellow]7[fg] additional cannon shots that deal [yellow]" ..
        get_character_stat("cannoneer", 3, "dmg") / 2 .. "[fg] AoE damage"
    end,
    ...
    ["plague_doctor"] = function()
      return "[fg]nearby enemies take an additional [yellow]" ..
        get_character_stat("plague_doctor", 3, "dmg") .. "[fg] damage per second"
    end,
    ["barbarian"] = function()
    ...
    ["juggernaut"] = function()
      return "[fg]enemies pushed by the juggernaut take [yellow]" ..
        4 * get_character_stat("juggernaut", 3, "dmg") .. "[fg] damage if they hit a wall"
    end,
    ["lich"] = function()
    ...
    ["pyromancer"] = function()
      return "[fg]enemies killed by the pyromancer explode, dealing [yellow]" ..
        get_character_stat("pyromancer", 3, "dmg") .. "[fg] AoE damage"
    end,
    ["corruptor"] = function()
    ...
    ["psykino"] = function()
      return "[fg]enemies take [yellow]" ..
        4 * get_character_stat("psykino", 3, "dmg") .. "[fg] damage and are pushed away when the area expires"
    end,
    ["barrager"] = function()
    ...
    ["witch"] = function()
      return "[fg]the area releases projectiles, each dealing [yellow]" ..
        get_character_stat("witch", 3, "dmg") .. "[fg] damage and chaining once"
    end,
    ["silencer"] = function()
      return "[fg]the curse also deals [yellow]" .. get_character_stat("silencer", 3, "dmg") .. "[fg] damage per second"
    end,
    ["vulcanist"] = function()
    ...
    ["usurer"] = function()
      return "[fg]if the same enemy is cursed [yellow]3[fg] times it takes [yellow]" ..
        10 * get_character_stat("usurer", 3, "dmg") .. "[fg] damage"
    end,
    ["gambler"] = function()
  ...
  character_effect_descriptions_gray = {
    ...
    ["blade"] = function()
      return "[light_bg]deal additional " ..
        math.round(get_character_stat("blade", 3, "dmg") / 2, 2) .. " damage per enemy hit"
    end,
    ["elementor"] = function()
    ...
    ["sage"] = function()
      return "[light_bg]when the projectile expires deal " ..
        3 * get_character_stat("sage", 3, "dmg") .. " damage to all enemies under its influence"
    end,
    ["squire"] = function()
    ...
    ["cannoneer"] = function()
      return "[light_bg]showers the hit area in 7 additional cannon shots that deal " ..
        get_character_stat("cannoneer", 3, "dmg") / 2 .. " AoE damage"
    end,
    ["dual_gunner"] = function()
    ...
    ["plague_doctor"] = function()
      return "[light_bg]nearby enemies take an additional " ..
        get_character_stat("plague_doctor", 3, "dmg") .. " damage per second"
    end,
    ["barbarian"] = function()
    ...
    ["juggernaut"] = function()
      return "[light_bg]enemies pushed by the juggernaut take " ..
        4 * get_character_stat("juggernaut", 3, "dmg") .. " damage if they hit a wall"
    end,
    ["lich"] = function()
    ...
    ["pyromancer"] = function()
      return "[light_bg]enemies killed by the pyromancer explode, dealing " ..
        get_character_stat("pyromancer", 3, "dmg") .. " AoE damage"
    end,
    ["corruptor"] = function()
    ...
    ["psykino"] = function()
      return "[light_bg]enemies take " ..
        4 * get_character_stat("psykino", 3, "dmg") .. " damage and are pushed away when the area expires"
    end,
    ["barrager"] = function()
    ...
    ["witch"] = function()
      return "[light_bg]the area periodically releases projectiles, each dealing " ..
        get_character_stat("witch", 3, "dmg") .. " damage and chaining once"
    end,
    ["silencer"] = function()
      return "[light_bg]the curse also deals " .. get_character_stat("silencer", 3, "dmg") .. " damage per second"
    end,
    ["vulcanist"] = function()
    ...
    ["usurer"] = function()
      return "[light_bg]if the same enemy is cursed 3 times it takes " ..
        10 * get_character_stat("usurer", 3, "dmg") .. " damage"
    end,
    ["gambler"] = function()
    ...
    ["thief"] = function()
      return "[light_bg]if the knife crits it deals " ..
        10 * get_character_stat("thief", 3, "dmg") .. " damage, chains 10 times and grants 1 gold"
    end
  }
        ...
        ylb1(lvl) ..
          "]3[light_bg]/[" ..
            ylb2(lvl) ..
              "]6 [fg]- [" ..
                ylb1(lvl) ..
                  "]8%[light_bg]/[" .. ylb2(lvl) .. "]16% [fg]chance to release a barrage on attack to allied rangers"
    end,
    ["warrior"] = function(lvl)
      return "[" ..
        ylb1(lvl) ..
          "]3[light_bg]/[" ..
            ylb2(lvl) ..
              "]6 [fg]- [" .. ylb1(lvl) .. "]+25[light_bg]/[" .. ylb2(lvl) .. "]+50 [fg]defense to allied warriors"
    end,
    ["mage"] = function(lvl)
      return "[" ..
        ylb1(lvl) ..
          "]3[light_bg]/[" ..
            ylb2(lvl) .. "]6 [fg]- [" .. ylb1(lvl) .. "]-15[light_bg]/[" .. ylb2(lvl) .. "]-30 [fg]enemy defense"
    end,
    ["rogue"] = function(lvl)
      return "[" ..
        ylb1(lvl) ..
          "]3[light_bg]/[" ..
            ylb2(lvl) ..
              "]6 [fg]- [" ..
                ylb1(lvl) ..
                  "]15%[light_bg]/[" ..
                    ylb2(lvl) .. "]30% [fg]chance to crit to allied rogues, dealing [yellow]4x[] damage"
    end,
    ["healer"] = function(lvl)
      return "[" ..
        ylb1(lvl) ..
          "]2[light_bg]/[" ..
            ylb2(lvl) ..
              "]4 [fg]- [" ..
                ylb1(lvl) ..
                  "]+15%[light_bg]/[" ..
                    ylb2(lvl) .. "]+30% [fg] chance to create [yellow]+1[fg] healing orb on healing orb creation"
    end,
    ["enchanter"] = function(lvl)
      return "[" ..
        ylb1(lvl) ..
          "]2[light_bg]/[" ..
            ylb2(lvl) ..
              "]4 [fg]- [" .. ylb1(lvl) .. "]+15%[light_bg]/[" .. ylb2(lvl) .. "]+25% [fg]damage to all allies"
    end,
    ["nuker"] = function(lvl)
      return "[" ..
        ylb1(lvl) ..
          "]3[light_bg]/[" ..
            ylb2(lvl) ..
              "]6 [fg]- [" ..
                ylb1(lvl) .. "]+15%[light_bg]/[" .. ylb2(lvl) .. "]+25% [fg]area damage and size to allied nukers"
    end,
    ["conjurer"] = function(lvl)
      return "[" ..
        ylb1(lvl) ..
          "]2[light_bg]/[" ..
            ylb2(lvl) ..
              "]4 [fg]- [" .. ylb1(lvl) .. "]+25%[light_bg]/[" .. ylb2(lvl) .. "]+50% [fg]construct damage and duration"
    end,
    ["psyker"] = function(lvl)
      return "[" ..
        ylb1(lvl) ..
          "]2[light_bg]/[" ..
            ylb2(lvl) ..
              "]4 [fg]- [" ..
                ylb1(lvl) ..
                  "]+2[light_bg]/[" .. ylb2(lvl) .. "]+4 [fg]total psyker orbs and [yellow]+1[fg] orb for each psyker"
    end,
    ["curser"] = function(lvl)
      return "[" ..
        ylb1(lvl) ..
          "]2[light_bg]/[" ..
            ylb2(lvl) ..
              "]4 [fg]- [" ..
                ylb1(lvl) .. "]+1[light_bg]/[" .. ylb2(lvl) .. "]+3 [fg]max curse targets to allied cursers"
    end,
    ["forcer"] = function(lvl)
      return "[" ..
        ylb1(lvl) ..
          "]2[light_bg]/[" ..
            ylb2(lvl) ..
              "]4 [fg]- [" .. ylb1(lvl) .. "]+25%[light_bg]/[" .. ylb2(lvl) .. "]+50% [fg]knockback force to all allies"
    end,
    ["swarmer"] = function(lvl)
      return "[" ..
        ylb1(lvl) ..
          "]2[light_bg]/[" ..
            ylb2(lvl) .. "]4 [fg]- [" .. ylb1(lvl) .. "]+1[light_bg]/[" .. ylb2(lvl) .. "]+3 [fg]hits to critters"
    end,
    ["voider"] = function(lvl)
      return "[" ..
        ylb1(lvl) ..
          "]2[light_bg]/[" ..
            ylb2(lvl) ..
              "]4 [fg]- [" ..
                ylb1(lvl) .. "]+20%[light_bg]/[" .. ylb2(lvl) .. "]+40% [fg]damage over time to allied voiders"
    end,
      ...
      return "[" ..
        ylb1(lvl) ..
          "]2[light_bg]/[" ..
            ylb2(lvl) ..
              "]4 [fg]- [" ..
                ylb1(lvl) .. "]+8%[light_bg]/[" .. ylb2(lvl) .. "]+16% [fg]chance for enemies to drop gold on death"
    end,
  ...
  get_class_levels = function(units)
    ...
    local units_to_class_level = function(number_of_units, class)
      ...
      elseif
        class == "healer" or class == "conjurer" or class == "enchanter" or class == "curser" or class == "forcer" or
          class == "swarmer" or
          class == "voider" or
          class == "mercenary" or
          class == "psyker"
    ...
    return "[" ..
      ylb1(lvl) ..
        "]" ..
          tostring(a) ..
            "[light_bg]/[" ..
              ylb2(lvl) .. "]" .. tostring(b) .. "[light_bg]/[" .. ylb3(lvl) .. "]" .. tostring(c) .. "[fg]"
  end
  passive_descriptions_level = {
    ...
    ["crucio"] = function(lvl)
      return "[fg]taking damage also shares that across all enemies at " .. ts(lvl, "20%", "30%", "40%") .. " its value"
    end,
    ...
    ["deceleration"] = function(lvl)
      return "[fg]enemies taking DoT damage have " .. ts(lvl, "-15%", "25%", "35%") .. " movement speed"
    end,
    ...
    ["hextouch"] = function(lvl)
      return "[fg]enemies take " ..
        ts(lvl, "10", "15", "20") .. "damage per second for [yellow]3[fg] seconds when cursed"
    end,
    ["whispers_of_doom"] = function(lvl)
      return "[fg]curses apply doom, deal " ..
        ts(lvl, "100", "150", "200") .. " every " .. ts(lvl, "4", "3", "2") .. " doom instances"
    end,
    ["tremor"] = function(lvl)
    ...
    ["baneling_burst"] = function(lvl)
      return "[fg]critters die immediately on contact but also deal " .. ts(lvl, "50", "100", "150") .. " AoE damage"
    end,
    ...
    ["explosive_arrow"] = function(lvl)
      return "[fg]ranger arrows have " ..
        ts(lvl, "+10%", "20%", "30%") .. " chance to deal " .. ts(lvl, "10%", "20%", "30%") .. " AoE damage"
    end,
    ["divine_machine_arrow"] = function(lvl)
      return "[fg]ranger arrows have a " ..
        ts(lvl, "10%", "20%", "30%") .. " chance to seek and pierce " .. ts(lvl, "1", "2", "3") .. " times"
    end,
    ...
    ["assassination"] = function(lvl)
      return "[fg]crits from rogues deal " ..
        ts(lvl, "8x", "10x", "12x") .. " damage but normal attacks deal [yellow]half[fg] damage"
    end,
    ["flying_daggers"] = function(lvl)
      return "[fg]all projectiles thrown by rogues chain " .. ts(lvl, "+2", "3", "4") .. " times"
    end,
    ["ultimatum"] = function(lvl)
      return "[fg]projectiles that chain gain " .. ts(lvl, "+10%", "20%", "30%") .. " damage with each chain"
    end,
    ...
    ["echo_barrage"] = function(lvl)
      return ts(lvl, "10%", "20%", "30%") ..
        " chance to create " .. ts(lvl, "1", "2", "3") .. " secondary AoEs on AoE hit"
    end,
    ["unleash"] = function(lvl)
      return "[fg]all nukers gain [yellow]+1%[fg] area size and damage every second"
    end,
    ["reinforce"] = function(lvl)
      return ts(lvl, "+10%", "20%", "30%") .. " global damage, defense and aspd if you have one or more enchanters"
    end,
    ["payback"] = function(lvl)
      return ts(lvl, "+2%", "5%", "8%") .. " damage to all allies whenever an enchanter is hit"
    end,
    ["enchanted"] = function(lvl)
      return ts(lvl, "+33%", "66%", "99%") .. " attack speed to a random unit if you have two or more enchanters"
    end,
    ...
    ["berserking"] = function(lvl)
      return "[fg]all warriors have up to " .. ts(lvl, "+50%", "75%", "100%") .. " attack speed based on missing HP"
    end,
    ["unwavering_stance"] = function(lvl)
      return "[fg]all warriors gain " .. ts(lvl, "+4%", "8%", "12%") .. " defense every [yellow]5[fg] seconds"
    end,
    ...
    ["divine_barrage"] = function(lvl)
      return ts(lvl, "20%", "40%", "60%") .. " chance to release a ricocheting barrage on healing orb pick up"
    end,
    ...
    ["taunt"] = function(lvl)
      return ts(lvl, "10%", "20%", "30%") .. " chance for constructs to taunt nearby enemies on attack"
    end,
    ["construct_instability"] = function(lvl)
      return "[fg]constructs explode when disappearing, dealing " .. ts(lvl, "100", "150", "200%") .. " damage"
    end,
    ...
    ["critical_strike"] = function(lvl)
      return ts(lvl, "5", "10", "15%") .. " chance for attacks to critically strike, dealing [yellow]2x[fg] damage"
    end,
    ...
    ["infesting_strike"] = function(lvl)
      return ts(lvl, "10", "20", "30%") .. " chance for attacks to spawn [yellow]2[fg] critters on kill"
    end,
    ["kinetic_strike"] = function(lvl)
      return ts(lvl, "10", "20", "30%") .. " chance for attacks to push enemies away with high force"
    end,
    ...
    ["silencing_strike"] = function(lvl)
      return ts(lvl, "8", "16", "24%") .. " chance for attacks to silence for [yellow]2[fg] seconds on hit"
    end,
    ["warping_shots"] = function(lvl)
      return "projectiles ignore wall collisions and warp around the screen " .. ts(lvl, "1", "2", "3") .. " times"
    end,
    ...
    ["lightning_strike"] = function(lvl)
      return ts(lvl, "5", "10", "15%") ..
        " chance for projectiles to create chain lightning, dealing " .. ts(lvl, "60", "80", "100%") .. " damage"
    end,
    ...
    function()
      ...
      if self:is(MainMenu) then
        self.ng_t =
          ...
          x = gw / 2 + 63,
          y = gh - 50,
          lines = {{text = "[bg10]current: " .. current_new_game_plus, font = pixul_font, alignment = "center"}}
        }
      end
      ...
      self.cooldown_snake_button =
        ...
        w = 145,
        force_update = true,
        button_text = "[bg10]cooldowns on snake: " .. tostring(state.cooldown_snake and "yes" or "no"),
        fg_color = "bg10",
        bg_color = "bg",
        action = function(b)
          ui_switch1:play {pitch = random:float(0.95, 1.05), volume = 0.5}
        ...
        self.ng_plus_minus_button =
          ...
          action = function(b)
            ...
            self.ng_t.text:set_text(
              {{text = "[bg10]current: " .. current_new_game_plus, font = pixul_font, alignment = "center"}}
            )
